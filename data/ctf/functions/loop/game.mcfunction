...
replaceitem entity @a[tag=!Tank,scores={HasBlueFlag=0,HasRedFlag=0}] armor.head minecraft:air
...
execute if score Game GameTime matches 3000 run tellraw @a [{"color": "green", "text": "5 Minutes remaining!"}] 
execute if score Game GameTime matches 6600 run tellraw @a [{"color": "green", "text": "2 Minutes remaining!"}] 
execute if score Game GameTime matches 7800 run tellraw @a [{"color": "green", "text": "1 Minutes remaining!"}] 
execute if score Game GameTime matches 8800 run tellraw @a [{"color": "green", "text": "Instant death activating in 10!"}] 
execute if score Game GameTime matches 8820 run tellraw @a [{"color": "green", "text": "9!"}]
execute if score Game GameTime matches 8840 run tellraw @a [{"color": "green", "text": "8!"}] 
execute if score Game GameTime matches 8860 run tellraw @a [{"color": "green", "text": "7!"}] 
execute if score Game GameTime matches 8880 run tellraw @a [{"color": "green", "text": "6!"}] 
execute if score Game GameTime matches 8900 run tellraw @a [{"color": "green", "text": "5!"}] 
execute if score Game GameTime matches 8920 run tellraw @a [{"color": "green", "text": "4!"}] 
execute if score Game GameTime matches 8940 run tellraw @a [{"color": "green", "text": "3!"}] 
execute if score Game GameTime matches 8940 run playsound minecraft:block.note_block.bell master @a ~ ~ ~ 1023 1
execute if score Game GameTime matches 8960 run tellraw @a [{"color": "green", "text": "2!"}] 
execute if score Game GameTime matches 8960 run playsound minecraft:block.note_block.bell master @a ~ ~ ~ 1023 1
execute if score Game GameTime matches 8980 run tellraw @a [{"color": "green", "text": "1!"}] 
execute if score Game GameTime matches 8980 run playsound minecraft:block.note_block.bell master @a ~ ~ ~ 1023 1

execute if score Game GameTime matches 9000 run tellraw @a [{"color": "green", "text": "Instant death mode activated! The next score wins!", "bold": "true", "italic": "true"}] 
execute if score Game GameTime matches 9000..9040 run playsound minecraft:block.note_block.bell master @a ~ ~ ~ 1023 2