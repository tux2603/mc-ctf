tellraw @a [{"color": "green", "text": "The red flag "}, {"color": "red", "text": "red flag"}, {"color": "green", "text": " has been recovered by "}, {"selector": "@e[scores={CallStack00=1}]", "color": "red"}, {"color": "green", "text": "!"}]
